...
<div class="row panel-body">
    ...
    <div class="col-md-2">
        ...
        <input type="text" id="min_count" name="min_count" required="required" class="form-control" value="{if $combination}{$combination.min_count}{/if}">
    </div>
    <div class="col-md-2">
        <label class="form-control-label">Product count</label>
        <span class="help-box" data-toggle="popover" data-content="Information" data-original-title="" title=""></span>
        <input type="text" id="product_count" name="product_count" required="required" class="form-control" value="{if $combination}{$combination.product_count}{/if}">
    </div>
    ...
    <div class="col-md-2">
        ...
        <button  type="button" class="btn btn-primary save uppercase save-relation-new submitCombination">Save</button>
    </div>
</div>
    </div>
{/foreach}