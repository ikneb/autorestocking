            ...
            <div class="col-md-6">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <select name="order_day" class="selectpicker">
                        ...
                        <option value="1" {if $combination.order_day && $combination.order_day == 1}selected{/if}>Mon
                        </option>
                        <option value="2" {if $combination.order_day && $combination.order_day == 2}selected{/if}>Tue
                        </option>
                        <option value="3" {if $combination.order_day && $combination.order_day == 3}selected{/if}>Wed
                        </option>
                        <option value="4" {if $combination.order_day && $combination.order_day == 4}selected{/if}>Thu
                        </option>
                        <option value="5" {if $combination.order_day && $combination.order_day == 5}selected{/if}>Fri
                        </option>
                        <option value="6" {if $combination.order_day && $combination.order_day == 6}selected{/if}>Sat
                        </option>
                        <option value="7" {if $combination.order_day && $combination.order_day == 7}selected{/if}>Sun
                        </option>
                    </select>
                </div>
