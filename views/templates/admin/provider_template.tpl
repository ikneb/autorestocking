    ...
    <div class="col-lg-2 col-md-3">
        <div class="list-group">
            ...
            <a class="list-group-item " data-toggle="tab" id="linkAddRelation"
               href="#addRelation">{l s='Add relation'}</a>
        </div>
    </div>
    <div class="tab-content">
            ...
            <form id="providers_form" class="defaultForm form-horizontal AdminProviders" method="post"
                ...
                <div class="panel" id="fieldset_0">
                    <div class="panel-heading">
                        <i class="icon-briefcase"></i>{l s='Providers'}
                    </div>
                    ...
                    <div class="panel-footer">
                        ...
                        <a href="index.php?controller=AdminProviders&amp;token=0f0bb702af1521fecfae53fdd682e2aa"
                           class="btn btn-default" onclick="window.history.back();">
                            <i class="process-icon-cancel"></i> {l s='Cansel'}
                        </a>
                    </div>
                </div>
            </form>
        ...
        <div id="addRelation" class="tab-pane col-lg-9 ">
            <div class="col-lg-6">
                <div class="panel" id="fieldset_0">
                    <div class="panel-heading">
                        <i class="icon-briefcase"></i> {l s='Check Product'}
                    </div>
                    <div class="form-group search-product">
                        <label class="control-label col-lg-3 ">
                            {l s='Search and add product'}</label>
                        <div class="input-group row">
                            <input type="text" id="related_product_autocomplete_input" name="product_autocomplete"/>
                            <span class="input-group-addon"><i class="icon-search"></i></span>
                            <div class="col-md-2">
                                <button type="button" class="btn btn-primary add-product">{l s='Add product'}</button>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-6">
                ...
                <div class="panel" id="fieldset_0">
                    <div class="panel-heading">
                        <i class="icon-briefcase"></i> {l s='Save'}
                    </div>
                    <ul class="list-group product-list" id="product-list">
                        <li class="list-group-item justify-content-between"><span class="name-product">{l s='ID'}</span>
                            <span class="name-product">{l s='Name'}</span><span
                                    class="badge badge-default badge-pill">{l s='Save'}</span>
                        </li>
                    </ul>
                    <div class="panel-footer">
